#' @export
transmission_hill_fxn<-function(dat,acute_phase_status,sti_status_sus,
                                condom_use,msm_sus_receptive_status,
                                msm_sus_insert_status,
                                msm_circum_status_insert_sus,
...
if(dat$param$model_sex=="msm") {
  ...
  result[which(hetero_sus_female==1)]  <-  result[which(hetero_sus_female==1)] * dat$param$trans_RR_receptive_vaginal
