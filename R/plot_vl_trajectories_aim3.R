...
plot_vl_trajectories_aim3<- function(model,sim,Therapy_Type,outpath,name)
{
  ...
  {  
    ...
    if(length(vl_ix>0)){
      ...
      lines(vl_df[vl_ix,5],log10(vl_df[vl_ix,18]),lwd=2,col="blue")
      lines(vl_df[vl_ix,5],log10(vl_df[vl_ix,19]),lwd=2,col="red")
      lines(vl_df[vl_ix,5],log10(vl_df[vl_ix,20]),lwd=2,col="green")
      lines(vl_df[vl_ix,5],log10(vl_df[vl_ix,21]),lwd=2,col="darkgreen")
      lines(vl_df[vl_ix,5],log10(vl_df[vl_ix,22]),lwd=2,col="purple")    
