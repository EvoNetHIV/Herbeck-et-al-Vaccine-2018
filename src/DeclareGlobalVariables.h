  ...
  double  K_Fitness; // Carrying capacity after accounting for cost of drug resistance
  double  KK_term; // Hill funciton like transformation on Kfitness
 ...
 // #include "Update_drug_concentrations.h"
  #include "Update_drug_concs_pill_combos.h"
