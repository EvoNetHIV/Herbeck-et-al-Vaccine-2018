...
evoparams$cd4_treatment_threshold = 3:4
evoparams$start_treatment_campaign = 7*365
evoparams$mean_time_tx = 365
evoparams$sd_time_tx = 365/2
evoparams$prob_eligible_ART = 0.40

# -- Vaccine parameters ----------------------------------------- #
# Vaccine scenario 1
evoparams$start_vacc_campaign = c(22*365, 27*365, 32*365)
evoparams$perc_virus_vaccine_sens <- 0.75
evoparams$trans_RR_vaccine <- 0.25
evoparams$perc_vaccinated <- 0.90
