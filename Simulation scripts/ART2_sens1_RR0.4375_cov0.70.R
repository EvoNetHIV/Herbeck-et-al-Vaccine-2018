...
evoparams$prob_eligible_ART = 0.70

# -- Vaccine parameters ----------------------------------------- #
# Vaccine scenario 1
evoparams$start_vacc_campaign = (22*365):(40*365)
evoparams$perc_virus_vaccine_sens <- 1
evoparams$trans_RR_vaccine <- 0.4375
evoparams$perc_vaccinated <- (0.70/(1-0.70))/(3*365)
...
model_name = paste("ART2_sens", evoparams$perc_virus_vaccine_sens,
